...
1785 to 1907 \cite{bourdo1956review,pattison1957beginnings,schulte2001original,goring2015tr}.
...
correction factors \cite{goring2015tr}
...
is limited \cite{liu2011broadscale}. Surveyors sometimes used ambiguous
common names, which requires matching to scientific names and standardization
\cite{mladenoff2002narrowing,goring2015tr}.
...
\begin{figure}
% \label{fig:domain}\includegraphics[scale=1.3]{fig1.pdf}
...
\nameref{SI}. In addition, in the latent variable representation, $\theta_{p}(s)$
...
% \hspace{4mm}\includegraphics[scale=0.16]{legendRaw.pdf}\hspace{4mm}\includegraphics[scale=0.16]{legendProp.pdf}\hspace{3.5mm}\includegraphics[scale=0.16]{legendSD.pdf}
...
% John Burk, Jim Dyer, Peter Marks, Robert McIntosh, Ed Schools, Ted Sickley, Ronald Stuckey
%Madeline Ruid, Benjamin Seliger, Morgan Ripp and Daniel Handel% This work was carried out by the PalEON Project
